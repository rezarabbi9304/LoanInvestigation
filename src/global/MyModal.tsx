...
import { MyAnimate } from "../global/animations//animate/MyAnimate";
import { RoundedClass } from "../global/enum/RoundedClass";
      ...
      {show && (
        ...
        >
          ...
          <motion.div
            ...
            exit={exitAnimation}
            className={`w-full overflow-hidden ${backgroundColor} shadow-sm rounded
            ${rounded}
